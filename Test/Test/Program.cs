...
namespace Test
{
    static class MathEx
    {
        ...
        public static bool isFactor(long factor,long num)
        {
            bool isFactor = false;
            if (num % factor == 0)
            {
        ...
        public static List<int> listDivisors(int num)
        {
            int upper = num;
        ...
        public static long largestPrimeFactor(long num)
        {
            ...
            {
                upper = num / i;
                if (MathEx.isFactor(upper,num) && MathEx.isPrime(upper))
                {
                    largest = upper;
                }
                else if (MathEx.isFactor(i, num) && MathEx.isPrime(i))
                {
                    largest = i;
                }
            }
        ...
        public static int largestPalindrome(int num1, int num2)
        {
            ...
            for (int i = num1; i <= num2; i++)
            {
                ...
                {
                    num = i * j;
                    if(MathEx.isPalindrome(num)&&num>largest)
                    {
                        largest=num;
                        prod1=i;
                        prod2=j;
            ...
            Console.WriteLine("Nums: {0},{1}", prod1, prod2);
            return largest;
        }
        ...
        public static int primePosition(int pos)
        {
            int prime = 0;
            int num = 1;
            while (prime < pos)
        ...
        public static long productInSeries()
        {
            ...
            char[] digits = number.ToCharArray();
            int[] numbers = Array.ConvertAll(digits,c => (int)Char.GetNumericValue(c));
            for (int i = 0; i < (numbers.Length-adj); i++)
            {
                prod = 1;
                ...
                {
                    largest = prod;
                    Console.WriteLine(i + "  " + (i+adj-1) + "  " + largest);
                }
            }
            return largest;
        }
        ...
        public static int triplet(int sum)
        {
            ...
            for (int a = 1; a < sum; a++)
            {
                for (int b = 1; b < sum; b++)
                {
                    for (int c = 1; c < sum; c++)
                    {
                        if ((a + b + c == sum) && MathEx.isTriplet(a, b, c))
                        {
        ...
        public static int triangleNumWithDiv(int num)
        {
            List<int> divisors=new List<int>();
            int triangleNum = 0;
            int level=0;
            ...
            do
            {
                level += 1;
                divisors.Clear();
                triangleNum = MathEx.triangleNumber(level);
                divisors = MathEx.listDivisors(triangleNum);
            } while (divisors.Count <= num);

            return triangleNum;
        }

        public static BigInteger sumOfNum()
        {
            BigInteger total = 0;
        ...
        public static int letters(int num)
        {
            int numLetters = 0;
            string numString="";
            string temp = "";
            ...
            lookup.Add(90, "ninety");
                ...
                else
                {
                    ...
                    if (value/ 100 > 0)
                    {
                        if (lookup.TryGetValue(value/100, out temp))
                        {
                            numString += temp+"hundred";
                            if (value % 100 != 0)
                            {
                                numString += "and";
                            }
                    ...
                    if (value > 9 && value < 20)
                    {
                        if (lookup.TryGetValue(value, out temp))
                        {
                            numString += temp;
                            value -= value;
                        }
                    ...
                    if (value / 10 > 1)
                    {
                        if(lookup.TryGetValue((value/10)*10,out temp))
                        {
                            numString+=temp;
                            value-=((value/10)*10);
                        }
        ...
        public static int sumLetters(int num)
        {
            ...
            for (int i = 1; i <=num; i++)
            {
                sum += MathEx.letters(i);
            }

            return sum;
        }

        public static int paths(int length)
        {
            int sumPrev=0;
            ...
            int paths = (4 * length) + (4*sumPrev);

            return paths;
        }

        public static int maxTrianglePath()
        {
            int max = 0;
            int sum1;
            int sum2;
    ...
    class Program
    {
        static void Main()
        {
            Console.WriteLine(MathEx.maxTrianglePath());
            Console.ReadLine();
        }
    }
}
